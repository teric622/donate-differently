...
function () {
  function class_1(hostRef) {
    ...
    this.pickerText = _Translations_dbe7c89e_js__WEBPACK_IMPORTED_MODULE_4__["T"].PICKER_TEXT;
    this.albumItems = [];
    this.imgArr = {};
    ...
    this.marshal = function (list) {
      list.forEach(function (item) {
        ...
        if (_storage_helpers_73297760_js__WEBPACK_IMPORTED_MODULE_7__["i"].has(ext)) {
...
function () {
  function class_1(hostRef) {
    ...
    this.fallbackText = _Translations_a762c194_js__WEBPACK_IMPORTED_MODULE_4__["T"].PICKER_TEXT;
  }
