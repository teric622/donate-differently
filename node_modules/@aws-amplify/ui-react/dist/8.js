...
/* harmony import */ var _storage_helpers_73297760_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./storage-helpers-73297760.js */ "../amplify-ui-components/dist/esm-es5/storage-helpers-73297760.js");
...
function () {
  function class_1(hostRef) {
    ...
    this.fallbackText = _Translations_dbe7c89e_js__WEBPACK_IMPORTED_MODULE_4__["T"].PICKER_TEXT;
  }
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          case 0:
            ...
            key = path + Object(_storage_helpers_73297760_js__WEBPACK_IMPORTED_MODULE_7__["c"])(file, fileToKey);
          ...
          case 1:
            ...
            return [4
            /*yield*/
            , Object(_storage_helpers_73297760_js__WEBPACK_IMPORTED_MODULE_7__["p"])(key, file, level, track, file['type'], logger)];
  ...
  class_1.prototype.render = function () {
    ...
    return Object(_index_a93ff41e_js__WEBPACK_IMPORTED_MODULE_0__["h"])(_index_a93ff41e_js__WEBPACK_IMPORTED_MODULE_0__["H"], null, Object(_index_a93ff41e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-s3-text", {
      textKey: this.src,
      path: this.path,
      level: this.level,
      track: this.track,
    ...
    }), Object(_index_a93ff41e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-picker", {
...
/***/ "../amplify-ui-components/dist/esm-es5/storage-helpers-73297760.js":
/*!*************************************************************************!*\
  !*** ../amplify-ui-components/dist/esm-es5/storage-helpers-73297760.js ***!
  \*************************************************************************/
...
/* harmony import */ var _Translations_a762c194_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Translations-a762c194.js */ "../amplify-ui-components/dist/esm-es5/Translations-a762c194.js");
/* harmony import */ var _constants_6835ae6a_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./constants-6835ae6a.js */ "../amplify-ui-components/dist/esm-es5/constants-6835ae6a.js");
...
var componentFieldMapping = {
  username: function username(ff) {
    return Object(_index_a93ff41e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-username-field", {
      label: ff.label,
  ...
  password: function password(ff) {
    return Object(_index_a93ff41e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-password-field", {
      label: ff.label,
      placeholder: ff.placeholder,
      hint: ff.hint,
      required: ff.required,
  ...
  email: function email(ff) {
    return Object(_index_a93ff41e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-email-field", {
      label: ff.label,
      placeholder: ff.placeholder,
      required: ff.required,
      handleInputChange: ff.handleInputChange,
  ...
  code: function code(ff) {
    return Object(_index_a93ff41e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-code-field", {
      label: ff.label,
      placeholder: ff.placeholder,
      hint: ff.hint,
      required: ff.required,
  ...
  phone_number: function phone_number(ff) {
    return Object(_index_a93ff41e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-phone-field", {
      label: ff.label,
      placeholder: ff.placeholder,
      required: ff.required,
      handleInputChange: ff.handleInputChange,
  ...
  "default": function _default(ff) {
    return Object(_index_a93ff41e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-form-field", {
      label: ff.label,
      placeholder: ff.placeholder,
      required: ff.required,
      handleInputChange: ff.handleInputChange,
...
function () {
  function AmplifyCodeField(hostRef) {
    ...
    this.fieldId = _constants_6835ae6a_js__WEBPACK_IMPORTED_MODULE_4__["j"];
    /** Used for the code label */

    this.label = _Translations_a762c194_js__WEBPACK_IMPORTED_MODULE_3__["T"].CODE_LABEL;
    /** Used for the placeholder label */

    this.placeholder = _Translations_a762c194_js__WEBPACK_IMPORTED_MODULE_3__["T"].CODE_PLACEHOLDER;
...
function () {
  function AmplifyCountryDialCode(hostRef) {
    ...
    this.fieldId = _constants_6835ae6a_js__WEBPACK_IMPORTED_MODULE_4__["C"];
  ...
  AmplifyCountryDialCode.prototype.render = function () {
    return Object(_index_a93ff41e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-select", {
      fieldId: this.fieldId,
...
function () {
  function AmplifyEmailField(hostRef) {
    ...
    this.fieldId = _constants_6835ae6a_js__WEBPACK_IMPORTED_MODULE_4__["E"];
    /** Used for the EMAIL label */

    this.label = _Translations_a762c194_js__WEBPACK_IMPORTED_MODULE_3__["T"].EMAIL_LABEL;
    /** Used for the placeholder label */

    this.placeholder = _Translations_a762c194_js__WEBPACK_IMPORTED_MODULE_3__["T"].EMAIL_PLACEHOLDER;
    /** The required flag in order to make an input required prior to submitting a form */
...
var amplifyFormSectionCss = ":host{--header-color:var(--amplify-secondary-color);--header-size:var(--amplify-text-md);--footer-color:var(--amplify-grey);--footer-size:var(--amplify-text-sm);--font-family:var(--amplify-font-family);--font-weight:var(--amplify-font-weight)}.form-section-header{color:var(--header-color);margin-bottom:24px;font-size:var(--header-size);font-weight:700}.form-section-footer{font-family:var(--font-family);font-weight:var(--font-weight);font-size:var(--footer-size);color:var(--footer-color);display:-ms-flexbox;display:flex;-ms-flex-direction:column;flex-direction:column;-ms-flex-pack:distribute;justify-content:space-around}@media (min-width: 672px){.form-section-footer{display:-ms-flexbox;display:flex;-ms-flex-direction:row-reverse;flex-direction:row-reverse;-ms-flex-pack:justify;justify-content:space-between;-ms-flex-align:baseline;align-items:baseline}}.form-section-footer *+*{margin-top:15px}";
...
function () {
  ...
  AmplifyFormSection.prototype.render = function () {
    return Object(_index_a93ff41e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("form", {
      onSubmit: this.handleSubmit
    }, Object(_index_a93ff41e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-section", null, Object(_index_a93ff41e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", null, Object(_index_a93ff41e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", {
      name: "amplify-form-section-header"
    }, Object(_index_a93ff41e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", {
      "class": "form-section-header"
    }, Object(_index_a93ff41e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("h3", {
      "data-test": this.testDataPrefix + '-header-section'
    }, this.headerText)))), Object(_index_a93ff41e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", null), Object(_index_a93ff41e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", null, Object(_index_a93ff41e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", {
    ...
    }, this.loading ? Object(_index_a93ff41e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-loading-spinner", null) : Object(_index_a93ff41e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", null, this.submitButtonText)), this.secondaryFooterContent)))));
  };
...
function () {
  function AmplifyPasswordField(hostRef) {
    ...
    this.fieldId = _constants_6835ae6a_js__WEBPACK_IMPORTED_MODULE_4__["k"];
    /** Used for the password label */

    this.label = _Translations_a762c194_js__WEBPACK_IMPORTED_MODULE_3__["T"].PASSWORD_LABEL;
    /** Used for the placeholder label */

    this.placeholder = _Translations_a762c194_js__WEBPACK_IMPORTED_MODULE_3__["T"].PASSWORD_PLACEHOLDER;
    /** The required flag in order to make an input required prior to submitting a form */
...
function () {
  function AmplifyPhoneField(hostRef) {
    ...
    this.fieldId = _constants_6835ae6a_js__WEBPACK_IMPORTED_MODULE_4__["b"];
    /** Used for the Phone label */

    this.label = _Translations_a762c194_js__WEBPACK_IMPORTED_MODULE_3__["T"].PHONE_LABEL;
    /** Used for the placeholder label */

    this.placeholder = _Translations_a762c194_js__WEBPACK_IMPORTED_MODULE_3__["T"].PHONE_PLACEHOLDER;
    /** The required flag in order to make an input required prior to submitting a form */
  ...
  AmplifyPhoneField.prototype.render = function () {
    return Object(_index_a93ff41e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", null, Object(_index_a93ff41e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-form-field", {
      label: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(this.label),
      type: "tel",
      hint: this.hint,
      required: this.required
      ...
      "class": "phone-field",
      slot: "input"
    }, Object(_index_a93ff41e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-country-dial-code", {
      dialCode: this.dialCode,
      handleInputChange: this.handleInputChange
    }), Object(_index_a93ff41e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-input", {
      fieldId: this.fieldId,
      handleInputChange: this.handleInputChange,
      placeholder: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(this.placeholder),
      name: this.fieldId,
...
function () {
  ...
  AmplifySelect.prototype.contructSelectOptions = function (opts) {
    ...
    opts.forEach(function (opt) {
      content.push(Object(_index_a93ff41e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("option", {
        value: opt.value,
  ...
  AmplifySelect.prototype.render = function () {
    return Object(_index_a93ff41e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("select", {
      name: this.fieldId,
      id: this.fieldId,
      "class": "select",
...
function () {
  function AmplifyUsernameField(hostRef) {
    ...
    this.fieldId = _constants_6835ae6a_js__WEBPACK_IMPORTED_MODULE_4__["l"];
    /** Used for the username label */

    this.label = _Translations_a762c194_js__WEBPACK_IMPORTED_MODULE_3__["T"].USERNAME_LABEL;
    /** Used for the placeholder label */

    this.placeholder = _Translations_a762c194_js__WEBPACK_IMPORTED_MODULE_3__["T"].USERNAME_PLACEHOLDER;
    /** The required flag in order to make an input required prior to submitting a form */
