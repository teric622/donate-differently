import { h, r as registerInstance } from './index-a93ff41e.js';
...
import { j as CODE_SUFFIX, C as COUNTRY_DIAL_CODE_SUFFIX, E as EMAIL_SUFFIX, k as PASSWORD_SUFFIX, b as PHONE_SUFFIX, l as USERNAME_SUFFIX } from './constants-6835ae6a.js';
...
const AmplifyPhoneField = class {
    ...
    render() {
        return (h("div", null, h("amplify-form-field", { label: I18n.get(this.label), type: "tel", hint: this.hint, required: this.required }, h("div", { class: "phone-field", slot: "input" }, h("amplify-country-dial-code", { dialCode: this.dialCode, handleInputChange: this.handleInputChange }), h("amplify-input", { fieldId: this.fieldId, handleInputChange: this.handleInputChange, placeholder: I18n.get(this.placeholder), name: this.fieldId, value: this.value, inputProps: this.inputProps, disabled: this.disabled })))));
    }
};
