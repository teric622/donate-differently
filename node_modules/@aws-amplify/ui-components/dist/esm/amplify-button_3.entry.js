import { r as registerInstance, h, g as getElement } from './index-a93ff41e.js';
import '@aws-amplify/core';
import './auth-types-78df304e.js';
import '@aws-amplify/auth';
<<<<<<< HEAD
import './Translations-dbe7c89e.js';
import './constants-6835ae6a.js';
import { e as hasShadowDom } from './helpers-3bfb485a.js';
=======
import './Translations-a762c194.js';
import './constants-6835ae6a.js';
import { e as hasShadowDom } from './helpers-6de03c53.js';
...
<<<<<<< HEAD
const amplifySectionCss = ":host{--font-family:var(--amplify-font-family);--background-color:var(--amplify-background-color)}.section{position:relative;margin-bottom:20px;background-color:var(--background-color);padding:35px 40px;text-align:left;display:inline-block;border-radius:6px;-webkit-box-shadow:1px 1px 4px 0 rgba(0, 0, 0, 0.15);box-shadow:1px 1px 4px 0 rgba(0, 0, 0, 0.15);-webkit-box-sizing:border-box;box-sizing:border-box;font-family:var(--font-family);width:100%;min-width:var(--min-width)}@media (min-width: 672px){.section{width:var(--width)}}";
=======
const amplifySectionCss = ":host{--font-family:var(--amplify-font-family)}.section{position:relative;margin-bottom:20px;background-color:var(--background-color);padding:35px 40px;text-align:left;display:inline-block;border-radius:6px;-webkit-box-shadow:1px 1px 4px 0 rgba(0, 0, 0, 0.15);box-shadow:1px 1px 4px 0 rgba(0, 0, 0, 0.15);-webkit-box-sizing:border-box;box-sizing:border-box;font-family:var(--font-family);width:100%;min-width:320px}@media (min-width: 672px){.section{width:auto;min-width:460px}}";
>>>>>>> 3bbb4d4b3bcbbb062fa08bc23180049a137e5e9d
