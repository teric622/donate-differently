...
import { S as SETUP_TOTP, h as SUCCESS, N as NO_AUTH_MODULE_FOUND } from './constants-6835ae6a.js';
import { d as dispatchAuthStateChangeEvent, a as dispatchToastHubEvent } from './helpers-3bfb485a.js';
import { c as checkContact } from './auth-helpers-56e74f02.js';
=======
...
import { N as NO_AUTH_MODULE_FOUND, S as SETUP_TOTP, h as SUCCESS } from './constants-6835ae6a.js';
import { d as dispatchAuthStateChangeEvent, a as dispatchToastHubEvent } from './helpers-6de03c53.js';
...
=======
        ...
        /** Used for customizing the issuer string in the qr code image */
        this.issuer = I18n.get(Translations.TOTP_ISSUER);
>>>>>>> 3bbb4d4b3bcbbb062fa08bc23180049a137e5e9d
        this.code = null;
...
>>>>>>> 3bbb4d4b3bcbbb062fa08bc23180049a137e5e9d
    ...
    render() {
        return (h("amplify-form-section", { headerText: I18n.get(this.headerText), submitButtonText: I18n.get(Translations.TOTP_SUBMIT_BUTTON_TEXT), handleSubmit: event => this.verifyTotpToken(event), loading: this.loading }, h("div", { class: "totp-setup" }, h("img", { src: this.qrCodeImageSource, alt: I18n.get(Translations.QR_CODE_ALT) }), h("amplify-form-field", { label: I18n.get(Translations.TOTP_LABEL), inputProps: this.inputProps, fieldId: "totpCode", name: "totpCode", handleInputChange: event => this.handleTotpInputChange(event) }))));
    }
};
