...
const storageHelpers = require('./storage-helpers-f23e5fc1.js');
=======
...
=======
            await storageHelper.putStorageObject(textKey, body, level, track, contentType, logger);
        }
        try {
            this.src = await storageHelper.getTextSource(key, level, track, identityId, logger);
>>>>>>> 3bbb4d4b3bcbbb062fa08bc23180049a137e5e9d
        }
        catch (err) {
            logger.debug(err);
