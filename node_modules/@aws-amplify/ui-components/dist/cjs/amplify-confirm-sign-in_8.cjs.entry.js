...
<<<<<<< HEAD
const Translations = require('./Translations-a554c511.js');
const constants = require('./constants-1eabe1d8.js');
const helpers = require('./helpers-35bcbc18.js');
const authHelpers = require('./auth-helpers-981c8af5.js');
=======
const Translations = require('./Translations-a771ba37.js');
const constants = require('./constants-1eabe1d8.js');
const helpers = require('./helpers-7d7d097c.js');
...
<<<<<<< HEAD
        await authHelpers.handleSignIn(this.signInAttributes.userInput, this.signInAttributes.password, this.handleAuthStateChange);
        this.loading = false;
=======
        try {
