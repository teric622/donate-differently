...
export class AmplifyConfirmSignUp {
    ...
    render() {
        return (h("amplify-form-section", { headerText: I18n.get(this.headerText), submitButtonText: I18n.get(this.submitButtonText), handleSubmit: this.handleSubmit, secondaryFooterContent: h("div", null,
                h("span", null,
