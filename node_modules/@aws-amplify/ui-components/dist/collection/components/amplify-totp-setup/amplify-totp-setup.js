...
import { AuthState, MfaOption } from '../../common/types/auth-types';
...
export class AmplifyTOTPSetup {
    ...
    render() {
        return (h("amplify-form-section", { headerText: I18n.get(this.headerText), submitButtonText: I18n.get(Translations.TOTP_SUBMIT_BUTTON_TEXT), handleSubmit: event => this.verifyTotpToken(event), loading: this.loading },
            h("div", { class: "totp-setup" },
                h("img", { src: this.qrCodeImageSource, alt: I18n.get(Translations.QR_CODE_ALT) }),
    ...
    static get properties() { return {
        ...
        "headerText": {
            ...
            "reflect": false,
            "defaultValue": "I18n.get(Translations.TOTP_HEADER_TEXT)"
        },
        "issuer": {
            "type": "string",
            "mutable": false,
            ...
            "attribute": "issuer",
            "reflect": false,
            "defaultValue": "I18n.get(Translations.TOTP_ISSUER)"
        }
    }; }
