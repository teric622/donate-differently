...
import { r as registerInstance, h } from './index-a93ff41e.js';
<<<<<<< HEAD
...
import { T as Translations } from './Translations-dbe7c89e.js';
import { N as NO_AUTH_MODULE_FOUND, g as COUNTRY_DIAL_CODE_DEFAULT } from './constants-6835ae6a.js';
import { d as dispatchAuthStateChangeEvent, a as dispatchToastHubEvent, c as checkUsernameAlias, i as isHintValid, h as handlePhoneNumberChange, b as composePhoneNumberInput, r as requiredAttributesMap } from './helpers-3bfb485a.js';
import { c as checkContact, h as handleSignIn } from './auth-helpers-56e74f02.js';
=======
import { isEmpty, I18n, Logger, ConsoleLogger } from '@aws-amplify/core';
import { M as MfaOption, C as ChallengeName, A as AuthState, a as AuthFormField } from './auth-types-78df304e.js';
import { Auth } from '@aws-amplify/auth';
import { T as Translations } from './Translations-a762c194.js';
import { N as NO_AUTH_MODULE_FOUND, g as COUNTRY_DIAL_CODE_DEFAULT } from './constants-6835ae6a.js';
import { d as dispatchAuthStateChangeEvent, a as dispatchToastHubEvent, c as checkUsernameAlias, i as isHintValid, h as handlePhoneNumberChange, b as composePhoneNumberInput, r as requiredAttributesMap } from './helpers-6de03c53.js';
...
<<<<<<< HEAD
                    ...
                    case 2:
                        ...
                        if (!this._signUpAttrs) return [3 /*break*/, 4];
...
=======
        return (h("amplify-form-section", { headerText: I18n.get(this.headerText), handleSubmit: this.handleSubmit, testDataPrefix: 'sign-up' }, h("amplify-auth-fields", { formFields: this.newFormFields }), h("div", { class: "sign-up-form-footer", slot: "amplify-form-section-footer" }, h("slot", { name: "footer" }, h("slot", { name: "secondary-footer-content" }, h("span", null, I18n.get(this.haveAccountText), ' ', h("amplify-button", { variant: "anchor", onClick: function () { return _this.handleAuthStateChange(AuthState.SignIn); }, "data-test": "sign-up-sign-in-link" }, I18n.get(this.signInText)))), h("slot", { name: "primary-footer-content" }, h("amplify-button", { type: "submit", "data-test": "sign-up-create-account-button" }, this.loading ? h("amplify-loading-spinner", null) : h("span", null, I18n.get(this.submitButtonText))))))));
>>>>>>> 3bbb4d4b3bcbbb062fa08bc23180049a137e5e9d
    };
...
=======
                    ...
                    case 3:
                        error_12 = _a.sent();
                        dispatchToastHubEvent(error_12);
